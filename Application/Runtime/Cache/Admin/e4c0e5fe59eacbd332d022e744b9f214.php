...
<html>
    ...
    <body>
        ...
        <div style="font-size: 13px;margin: 10px 5px">
            <form action="/phoneshop/index.php/Admin/Goods/update/goods_id/147" method="post" enctype="multipart/form-data">
                ...
                <tr>
                    ...
                    <td>
                        <select name="goods_category_id" id="goods_category_id">
                            <option value="<?php echo ($data["cat_name"]); ?>">请选择</option>
 							 <?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo['cat_id'] == $data['goods_category_id']): ?><option value="<?php echo ($vo["cat_id"]); ?>" selected="selected"><?php echo ($vo["cat_name"]); ?></option>
                            <?php else: ?>
