        ...
        <div class="div_head">
            <span>
                ...
                <span style="float: right; margin-right: 8px; font-weight: bold;">
                    <a style="text-decoration: none;" href="/phoneshop/index.php/Admin/Authority/add">【添加权限】</a>
                </span>
            </span>
        </div>
        <div></div>
            ...
            <table class="table_a" border="1" width="100%">
                <tbody><tr style="font-weight: bold;">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="product1">
                        ...
                        <td><a href="/phoneshop/index.php/Admin/Authority/update/auth_id/<?php echo ($vo["auth_id"]); ?>">修改</a></td>
                        <td><a href="/phoneshop/index.php/Admin/Authority/delete/auth_id/<?php echo ($vo["auth_id"]); ?>" onclick="return confirm('确定要删除吗?')">删除</a></td>
                    </tr>
                    <tr id="product2">
                    </tr>
